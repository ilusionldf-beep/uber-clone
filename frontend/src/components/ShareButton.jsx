export default function ShareButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 z-40 flex items-center justify-center bg-[#25D366] hover:bg-[#20b858] active:scale-95 text-white w-11 h-11 rounded-full shadow-xl transition"
